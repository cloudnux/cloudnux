...
import { useTaskManager, selectTask, selectProgress, selectRootTasks } from "../store/build.js";
import { AppProps, Args, Config } from "../types.js";
...
const TaskStatus: FC<TaskStatusProps> = ({ taskId, isActive, indent = 0 }) => {
...
export default function BuildView({
    ...
    const isRunning = useTaskManager(state => state.isRunning);
