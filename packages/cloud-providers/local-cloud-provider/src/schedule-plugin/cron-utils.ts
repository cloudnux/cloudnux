...
export function parseCronExpression(
    ...
    try {
        ...
        //BREAKPOINT: LOGGING
        //consola.error(`${chalk.red('Invalid cron expression:')} ${cronExpression} - ${error.message}`);
...
export function getNextExecutions(
    ...
    try {
        ...
        //BREAKPOINT: LOGGING
        //consola.error(`${chalk.red('Error getting next executions:')} ${error.message}`);
        return [];
    }
}
 ...
 */
export function detectExpressionType(expression: string): 'cron' | 'rate' | 'unknown' {
